  ...
  Widget buildListView(
    ...
    if (snapshot.data.countries.length > 0) {
      ...
      if (snapshot.data.countries.indexWhere((country) =>
              country.value == widget.customer.data.billing.country) !=
          -1) {
        regions = snapshot.data.countries
            .singleWhere((country) =>
                country.value == widget.customer.data.billing.country)
            .regions;
      } else if (snapshot.data.countries.indexWhere((country) =>
              country.value == widget.customer.data.billing.country) ==
          -1) {
    ...
    if (regions != null && regions.isNotEmpty) {
      widget.customer.data.billing.state =
          regions.any((z) => z.value == widget.customer.data.billing.state)
              ? widget.customer.data.billing.state
              : regions.first.value;
    }
              ...
              children: <Widget>[
                ...
                PrimaryColorOverride(
                  child: TextFormField(
                    ...
                    onSaved: (value) {
                      widget.customer.data.firstName = value;
                    },
                  ),
                ),
                ...
                PrimaryColorOverride(
                  child: TextFormField(
                    ...
                    onSaved: (value) {
                      widget.customer.data.lastName = value;
                    },
                  ),
                ),
                SizedBox(height: 12.0),
                PrimaryColorOverride(
                  child: TextFormField(
                    ...
                    validator: (value) {
                      if (value.isEmpty) {
                        return widget
                            .appStateModel.blocks.localeText.selectLocation;
                      }
                      return null;
                    },
                    onSaved: (value) {
                      widget.customer.data.billing.address1 = value;
                    },
                  ),
                ),
                /*SizedBox(height: 12.0),
                ...
                PrimaryColorOverride(
                  child: TextFormField(
                    ...
                    onSaved: (value) {
                      widget.customer.data.billing.postcode = value;
                    },
                  ),
                ),
                SizedBox(height: 12.0),
                PrimaryColorOverride(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText:
                            widget.appStateModel.blocks.localeText.email),
                    onSaved: (value) {
                    ...
                    ? Column(
                        children: [
                          ...
                          DropdownButton<String>(
                            ...
                            hint: Text(
                                widget.appStateModel.blocks.localeText.country),
                            isExpanded: true,
                            ...
                            onChanged: (String newValue) {
                              setState(() {
                                widget.customer.data.billing.country = newValue;
                                widget.customer.data.billing.state = '';
                              });
                            },
                ...
                (regions != null && regions.isNotEmpty)
                    ? Column(
                        children: <Widget>[
                          ...
                          DropdownButton<String>(
                            ...
                            hint: Text(
                                widget.appStateModel.blocks.localeText.states),
                            isExpanded: true,
                            icon: Icon(Icons.arrow_drop_down),
                            iconSize: 24,
                            elevation: 16,
                            ...
                            onChanged: (String newValue) {
                              setState(() {
                                widget.customer.data.billing.state = newValue;
                              });
                            },
                            items:
                                regions.map<DropdownMenuItem<String>>((value) {
                              return DropdownMenuItem<String>(
                                value: value.value != null ? value.value : '',
                                child: Text(parseHtmlString(value.label)),
                              );
                    ...
                    : PrimaryColorOverride(
                        child: TextFormField(
                          ...
                          onSaved: (val) => setState(() => widget
                              .customerBloc.formData['billing_state'] = val),
                        ),
                      ),
              ],
            ),
              ...
              RaisedButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    ...
                    widget.customerBloc.addressFormData['billing_first_name'] =
                        widget.customer.data.billing.firstName;
                    widget.customerBloc.addressFormData['billing_last_name'] =
                        widget.customer.data.billing.lastName;
                    widget.customerBloc.addressFormData['billing_address_1'] =
                    ...
                    widget.customerBloc.addressFormData['billing_city'] =
                        widget.customer.data.billing.city;
                    widget.customerBloc.addressFormData['billing_postcode'] =
                        widget.customer.data.billing.postcode;
                    widget.customerBloc.addressFormData['billing_email'] =
                        widget.customer.data.billing.email;
                    widget.customerBloc.addressFormData['billing_phone'] =
                        widget.customer.data.billing.phone;
                    widget.customerBloc.addressFormData['billing_country'] =
                        widget.customer.data.billing.country != null
                            ? widget.customer.data.billing.country
                            : '';
                    widget.customerBloc.addressFormData['billing_state'] =
                        widget.customer.data.billing.state != null
                            ? widget.customer.data.billing.state
                            : '';
