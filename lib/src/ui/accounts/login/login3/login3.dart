                  ...
                  children: [
                    ...
                    if (screenState == ScreenState.ForgotPassword)
                      Column(
                        children: [
                          ForgotPassword(
                              model: model, emailController: emailController),
                          SizedBox(
                            height: 10,
                          ),
                          InkWell(
      ...
      title: Text(
        screenState == ScreenState.Login
            ...
            : screenState == ScreenState.Register
                ...
                : screenState == ScreenState.ForgotPassword
                    ? 'FORGOT PASSWORD '
                    : screenState == ScreenState.ResetPassWord
                        ? 'RESET PASSWORD'
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future _registerUser(BuildContext context) async {
    if (_formKey.currentState.validate()) {
      ...
      bool status = await widget.model.register(_register.toJson(), context);
      setState(() {
        isLoading = false;
      });
      if (status) {
          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: RaisedButton(
                ...
                child: ButtonText(
                    isLoading: isLoading,
                    text: widget.model.blocks.localeText.sendOtp),
        ...
        child: new Column(
          ...
          children: <Widget>[
            CustomTextFormField(
              ...
              validationMsg: widget.model.blocks.localeText.pleaseEnterOtp,
              password: false,
            ...
            CustomTextFormField(
              ...
              validationMsg: widget.model.blocks.localeText.pleaseEnterPassword,
              password: true,
              inputType: TextInputType.text,
              icon: Icons.vpn_key,
            ),
    ...
    return TextFormField(
      decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(50),
            borderSide:
                BorderSide(color: Colors.grey.withOpacity(.3), width: 1.0),
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(50),
            borderSide: BorderSide(color: Colors.black, width: 1.0),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: RaisedButton(
              shape: StadiumBorder(),
              child: ButtonText(
                  isLoading: _loadingNumber,
                  text: widget.appStateModel.blocks.localeText.verifyNumber),
      ...
      child: new Form(
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            new BaseTextField(
              labelText: widget.appStateModel.blocks.localeText
                  .enterOtp, //'ENTER OTP(6 digits)',
              validator: (String value) {
                if (value == null || value.trim().isEmpty)
                  return widget.appStateModel.blocks.localeText.inValidCode;
                return value.length == 6
                    ? null
                    : widget.appStateModel.blocks.localeText.inValidCode;
              },
              onSaved: (String value) {
                smsOTP = value;
              },
            ...
            SizedBox(
              ...
              child: RaisedButton(
                child: ButtonText(
                    ...
                    text: widget.appStateModel.blocks.localeText.verifyOtp),
    ...
    switch (error.code) {
      case 'ERROR_INVALID_VERIFICATION_CODE':
        ...
        Fluttertoast.showToast(
            msg: widget.appStateModel.blocks.localeText.inValidCode);
        Navigator.of(context).pop();
        break;
      default:
        Navigator.of(context).pop();
  ...
  handlePhoneNumberError(PlatformException error) {
    switch (error.code) {
      case 'TOO_LONG':
        FocusScope.of(context).requestFocus(new FocusNode());
        Fluttertoast.showToast(
            msg: widget.appStateModel.blocks.localeText.inValidNumber);
        Navigator.of(context).pop();
        break;
      case 'TOO_SHORT':
        FocusScope.of(context).requestFocus(new FocusNode());
