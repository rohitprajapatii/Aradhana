              ...
              children: <Widget>[
                ...
                PrimaryColorOverride(
                  child: CustomTextFormField(
                    ...
                    password: false,
                    validationMsg:
                        widget.model.blocks.localeText.pleaseEnterUsername,
                  ),
                ),
                ...
                FlatButton(
                    ...
                    child: Text(widget.model.blocks.localeText.forgotPassword,
                ...
                FlatButton(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(widget.model.blocks.localeText.dontHaveAnAccount,
                            style: Theme.of(context).textTheme.bodyText2),
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 8.0),
                          child: Text(widget.model.blocks.localeText.signUp,
