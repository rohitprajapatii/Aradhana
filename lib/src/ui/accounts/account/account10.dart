...
class UserAccount10 extends StatefulWidget {
  UserAccount10({Key key}) : super(key: key);
...
class _UserAccount10State extends State<UserAccount10> {
      ...
      child: Column(
        children: [
          ListTile(
            ...
            title: (model.user?.billing?.firstName != null ||
                    model.user?.billing?.lastName != null)
                ? Text(
                    model.user.billing.firstName[0].toUpperCase() +
                        model.user.billing.firstName.substring(1) +
                        ' ' +
                        model.user.billing.lastName[0].toUpperCase() +
                        model.user.billing.lastName.substring(1),
                  )
                : Text(
          ...
          ListTile(
            ...
            leading:
                ExcludeSemantics(child: Icon(FlutterIcons.shopping_cart_fea)),
            title: Text(
              ...
              return Column(
                children: <Widget>[
                  ListTile(
                    ...
                    leading: ExcludeSemantics(child: Icon(Icons.attach_money)),
                    title: Text(
  ...
  Widget buildVendorDashboard(BuildContext context) {
    ...
    return ScopedModelDescendant<AppStateModel>(
        builder: (context, child, model) {
      if (model.loggedIn && appStateModel.isVendor.contains(model.user.role)) {
        return ListView(
          children: [
            Padding(
            ...
            Column(
              children: [
                ...
                ListTile(
                    ...
                    title: Text(appStateModel.blocks.localeText.orders,
                        style: itemTextStyle),
                    trailing: Icon(
                      Icons.arrow_forward_ios,
                      size: 15,
                ...
                ListTile(
                    ...
                    title: Text(appStateModel.blocks.localeText.info,
                        style: itemTextStyle),
                    trailing: Icon(
                      Icons.arrow_forward_ios,
                      size: 15,
  ...
  ListView buildOtherList(BuildContext context) {
    return ListView(
      children: [
        ListTile(
          onTap: () => Navigator.push(
              context, MaterialPageRoute(builder: (context) => TryDemo())),
          leading: ExcludeSemantics(
