...
class _OrderDetailState extends State<OrderDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar:
            AppBar(title: Text(widget.appStateModel.blocks.localeText.order)),
          ...
          children: <Widget>[
            ...
            widget.order.lineItems != null
                ? Column(
                    ...
                    children: <Widget>[
                        Text(
                          widget.appStateModel.blocks.localeText.products
                              .toUpperCase(),
                          style: Theme.of(context).textTheme.subtitle,
                        ),
                        SizedBox(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text(formatter
                  .format((double.parse('${widget.order.shippingTotal}')))),
            ],
          ),
          SizedBox(height: 10.0),
          Row(
            ...
            children: <Widget>[
              ...
              Text(
                  formatter.format((double.parse('${widget.order.totalTax}')))),
            ],
          ),
          SizedBox(height: 10.0),
          Row(
            ...
            children: <Widget>[
              ...
              Text(formatter
                  .format((double.parse('${widget.order.discountTotal}')))),
            ],
          ),
          SizedBox(height: 10.0),
          Row(
                        ...
                        Container(
                          ...
                          child: Text(
                            widget.order.lineItems[index].name +
                                ' x ' +
                                widget.order.lineItems[index].quantity
                                    .toString(),
                            maxLines: 2,
