          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                    'Note - Before contine please read document clearly, install plugin and save settings',
                    style: TextStyle(color: Theme.of(context).accentColor)),
                SizedBox(height: 6.0),
                InkWell(
                    child: new Text(
                      'https://mstoreapp.com/documents/flutter/woocommerce/woocommerce/wordpress_plugin_installtion.html',
