                          ...
                          if (snapshot.hasData && snapshot.data.length > 0) {
                            return Container(
                              ...
                              appStateModel.blocks.localeText.balance +
                                  ' ' +
                                  formatter.format(
                                      double.parse(snapshot.data[0].balance)),
                            ...
                            validator: (value) {
                              if (value.isEmpty) {
                                return appStateModel.blocks.localeText
                                    .pleaseEnterRechargeAmount;
                              }
                              return null;
                            },
                            decoration: InputDecoration(
                              labelText: appStateModel
                                  .blocks.localeText.enterRechargeAmount,
                            ),
                          ...
                          RaisedButton(
                            onPressed: () async {
                              if (_formKey.currentState.validate()) {
                                ...
                                data['woo_wallet_topup'] = appStateModel.blocks
                                    .nonce.wooWalletTopup; // Replace with nonce
                            ...
                            child: ButtonText(
                                isLoading: isLoading,
                                text:
                                    appStateModel.blocks.localeText.addBalance),
                          )
                        ],
                      ),
                    ),
