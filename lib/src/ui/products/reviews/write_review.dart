              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText: appStateModel
                                      .blocks.localeText.yourReview,
                                  errorMaxLines: 1,
                                ),
                                validator: (value) {
                                  if (value.isEmpty) {
                                    return appStateModel
                                        .blocks.localeText.pleaseEnterMessage;
                                  }
                                  return null;
                                },
                              ),
                    ...
                    buildTextFormField(
                        nameController, appStateModel.blocks.localeText.name),
                    SizedBox(
                      height: 20,
                    ),
                    buildTextFormField(
                        emailController, appStateModel.blocks.localeText.email),
                    SizedBox(
                      height: 20,
                    ),
                    Center(
