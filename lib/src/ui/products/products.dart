...
import 'product_grid/product_item14.dart';
...
class _ProductsWidgetState extends State<ProductsWidget>
                  ...
                  child: InkWell(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: selectedCategory?.name == null ? 'Search in ' + widget.name : 'Search in ' + selectedCategory.name,
                        hintStyle: TextStyle(
                          fontSize: 16,
                          fontFamily: 'Circular',
                        ),
            ...
            child: Container(
              ...
              child: InkWell(
                ...
                child: TextField(
                  ...
                  enabled: false,
                  decoration: InputDecoration(
                    hintText: selectedCategory?.name == null ? 'Search in ' + parseHtmlString(widget.name) : 'Search in ' + parseHtmlString(selectedCategory.name),
                    hintStyle: TextStyle(
                      fontSize: 16,
                      fontFamily: 'Circular',
                    ),
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (BuildContext context) =>
                        FilterProduct2(productsBloc: widget.productsBloc),
  ...
  void _showPopupMenu() async {
    final result = await showMenu(
      ...
      items: [
        PopupMenuItem<List>(child: const Text('Date'), value: ['date', 'ASC']),
        PopupMenuItem<List>(
            child: Text('Price High to Low'), value: ['price', 'DESC']),
        PopupMenuItem<List>(
            child: Text('Price Low to High'), value: ['price', 'ASC']),
        PopupMenuItem<List>(
            child: Text('New Arrivals'), value: ['date', 'DESC']),
        PopupMenuItem<List>(
            child: Text('Popular'), value: ['popularity', 'ASC']),
        PopupMenuItem<List>(child: Text('Rating'), value: ['rating', 'ASC']),
      ],
      elevation: 4.0,
    );
    if(result != null)
  ...
  _sort(String orderBy, String order) {
    ...
    print(widget.productsBloc.productsFilter);
    widget.productsBloc.fetchAllProducts(widget.productsBloc.productsFilter['id']);
  }
