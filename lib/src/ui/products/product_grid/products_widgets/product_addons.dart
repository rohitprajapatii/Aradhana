...
class ProductAddons extends StatefulWidget {
  ...
  const ProductAddons(
      {Key key, this.product, this.addOnsFormData, this.addonFormKey})
      : super(key: key);
...
class _ProductAddonsState extends State<ProductAddons> {
  ...
  void initState() {
    ...
    if (widget.product.metaData
        .any((element) => element.key == '_product_addons_exclude_global')) {
      excludeGlobal = widget.product.metaData
              .singleWhere(
                  (element) => element.key == '_product_addons_exclude_global')
              .value ==
          '1';
    }
    ...
    for (var value in widget.product.metaData) {
      if (value.key == '_product_addons') {
        ...
        addonFields = List<AddonField>.from(
            jsondata["value"].map((x) => AddonField.fromJson(x)));
      }
    }
  ...
  buildList(AppStateModel model) {
    ...
    if (model.productAddons.length > 0 && !excludeGlobal)
      for (var i = 0; i < model.productAddons.length; i++) {
        ...
        if (model.productAddons[i].restrictToCategories.keys.length == 0 ||
            inRestricted)
          for (var f = 0; f < model.productAddons[i].fields.length; f++) {
            if (model.productAddons[i].fields[f].type == 'custom') {
              if (model.productAddons[i].fields[f].options.length > 0) {
                list.add(ListTile(
                  ...
                  title: Text(model.productAddons[i].fields[f].name,
                      style: headingStyle),
                  subtitle: Text(model.productAddons[i].fields[f].description),
                ));
                for (var o = 0;
                    o < model.productAddons[i].fields[f].options.length;
                    o++) {
                  list.add(Container(
                    height: 50,
                    //color: Colors.green,
                    child: TextFormField(
                      onSaved: (value) {
                        setState(() {
                          widget.addOnsFormData[
                              _getKey(model.productAddons, i, f, o)] = value;
                        });
                      },
                      validator: (value) {
                        if (model.productAddons[i].fields[f].required == 1 &&
                            value.isEmpty) {
                      ...
                      decoration: InputDecoration(
                        labelText: model
                                .productAddons[i].fields[f].options[o].label +
                            ' ' +
                            _getPrice(
                                model.productAddons[i].fields[f].options[o]),
                      ),
                    ),
                  ));
                }
            ...
            if (model.productAddons[i].fields[f].type == 'custom_textarea' ||
                model.productAddons[i].fields[f].type == 'custom_text') {
              if (model.productAddons[i].fields[f].options.length > 0) {
                list.add(ListTile(
                  contentPadding: EdgeInsets.all(0),
                  title: Text(model.productAddons[i].fields[f].name,
            ...
            if (model.productAddons[i].fields[f].type == 'checkbox' &&
                model.productAddons[i].fields[f].display == 'select') {
              list.add(ListTile(
                contentPadding: EdgeInsets.all(0),
                title: Text(model.productAddons[i].fields[f].name,
                    style: headingStyle),
              ...
              for (var o = 0;
                ...
                list.add(
                  CheckboxListTile(
                    ...
                    value: widget.addOnsFormData[_getCheckBoxSelectKey(
                            model.productAddons, i, f, o)] ==
                        model.productAddons[i].fields[f].options[o].label
                            .toLowerCase()
                            .replaceAll(' ', '-'),
                    onChanged: (bool value) {
                      if (value) {
                        setState(() {
                          widget.addOnsFormData[
                              _getCheckBoxSelectKey(
                                  model.productAddons, i, f, o)] = model
                              .productAddons[i].fields[f].options[o].label
                              .toLowerCase()
                              .replaceAll(' ',
                                  '-'); //*** For Lower version of addons ***/
                        });
                      } else {
                        setState(() {
                          widget.addOnsFormData.remove(_getCheckBoxSelectKey(
                              model.productAddons, i, f, o));
                        });
                      }
                    },
                    title: Row(
                      children: [
                        Text(model.productAddons[i].fields[f].options[o].label),
                        SizedBox(width: 6),
                        Text(_getPrice(
                            model.productAddons[i].fields[f].options[o])),
                      ],
            ...
            if (model.productAddons[i].fields[f].type == 'multiple_choice' &&
                model.productAddons[i].fields[f].display == 'select') {
              list.add(ListTile(
                contentPadding: EdgeInsets.all(0),
                title: Text(model.productAddons[i].fields[f].name,
              ...
              for (var o = 0;
                ...
                list.add(
                  CheckboxListTile(
                    controlAffinity: ListTileControlAffinity.leading,
                    value: widget.addOnsFormData[
                            _getCheckBoxKey(model.productAddons, i, f, o)] ==
                        model.productAddons[i].fields[f].options[o].label
                                .toLowerCase()
                                .replaceAll(' ', '-') +
                            '-' +
                    ...
                    onChanged: (bool value) {
                      if (value) {
                        setState(() {
                          widget.addOnsFormData[_getCheckBoxKey(
                              model.productAddons, i, f, o)] = model
                                  .productAddons[i].fields[f].options[o].label
                                  .toLowerCase()
                                  .replaceAll(' ', '-') +
                              '-' +
                              (o + 1)
                                  .toString(); //*** For Lower version of addons ***/
                        });
                      } else {
                        setState(() {
                          widget.addOnsFormData.remove(
                              _getCheckBoxKey(model.productAddons, i, f, o));
                        });
                      }
                    },
            ...
            if (model.productAddons[i].fields[f].type == 'multiple_choice' &&
                model.productAddons[i].fields[f].display == 'radiobutton') {
              list.add(ListTile(
                contentPadding: EdgeInsets.all(0),
                title: Text(model.productAddons[i].fields[f].name,
                    style: headingStyle),
              ...
              for (var o = 0;
                ...
                list.add(
                  RadioListTile<String>(
                    ...
                    value: model.productAddons[i].fields[f].options[o].label
                            .toLowerCase()
                            .replaceAll(' ', '-') +
                        '-' +
                        (o + 1).toString(),
                    groupValue: widget.addOnsFormData[
                        _getRadioKey(model.productAddons, i, f)],
                    onChanged: (String value) {
                      setState(() {
                        widget.addOnsFormData[
                            _getRadioKey(model.productAddons, i, f)] = value;
                      });
                    },
                  ),
                );
            ...
            if (model.productAddons[i].fields[f].type == 'select') {
              if (widget.addOnsFormData[
                      _getSelectKey(model.productAddons, i, f)] ==
                  null) {
                widget.addOnsFormData[
                    _getSelectKey(model.productAddons, i, f)] = model
                        .productAddons[i].fields[f].options.first.label
                        .toLowerCase()
                        .replaceAll(' ', '-') +
                    '-1';
              }
              ...
              list.add(
                DropdownButton<AddonOption>(
                    ...
                    setState(() {
                      widget.addOnsFormData[
                          ...
                          value.label.toLowerCase().replaceAll(' ', '-') +
                              '-' +
                              (model.productAddons[i].fields[f].options
                                          .indexOf(value) +
                                      1)
                                  .toString();
                    });
                  ...
                  items: model.productAddons[i].fields[f].options
                      .map<DropdownMenuItem<AddonOption>>((value) {
    ...
    if (addonFields.length > 0)
      for (var f = 0; f < addonFields.length; f++) {
              ...
              list.add(Container(
                ...
                child: TextFormField(
                  onSaved: (value) {
                    setState(() {
                      widget.addOnsFormData[
                          _getProductKey(addonFields[f], f, o)] = value;
                    });
                  },
                  validator: (value) {
        ...
        if (addonFields[f].type == 'custom_textarea' ||
            addonFields[f].type == 'custom_text') {
          if (addonFields[f].options.length > 0) {
            list.add(ListTile(
              contentPadding: EdgeInsets.all(0),
              title: Text(addonFields[f].name, style: headingStyle),
        ...
        if (addonFields[f].type == 'checkbox' &&
            addonFields[f].display == 'select') {
          list.add(ListTile(
            contentPadding: EdgeInsets.all(0),
            title: Text(addonFields[f].name, style: headingStyle),
            subtitle: Text(addonFields[f].description),
          ...
          for (var o = 0; o < addonFields[f].options.length; o++) {
            list.add(
              CheckboxListTile(
                controlAffinity: ListTileControlAffinity.leading,
                value: widget.addOnsFormData[
                        _getProductCheckBoxKey(addonFields[f], f, o)] ==
                    addonFields[f]
                        .options[o]
                        .label
                        .toLowerCase()
                        .replaceAll(' ', '-'), // + '-' + (o + 1).toString()
                onChanged: (bool value) {
                  if (value) {
                    setState(() {
                      widget.addOnsFormData[
                    ...
                    setState(() {
                      widget.addOnsFormData
                          .remove(_getProductCheckBoxKey(addonFields[f], f, o));
                    });
                  }
                },
                title: Row(
                  children: [
                    Text(addonFields[f].options[o].label),
                    SizedBox(width: 6),
                    Text(_getPrice(addonFields[f].options[o])),
                  ],
                ),
              ),
            );
        ...
        if (addonFields[f].type == 'multiple_choice' &&
            addonFields[f].display == 'select') {
          list.add(ListTile(
            contentPadding: EdgeInsets.all(0),
            title: Text(addonFields[f].name, style: headingStyle),
          ...
          for (var o = 0; o < addonFields[f].options.length; o++) {
            list.add(
              CheckboxListTile(
                controlAffinity: ListTileControlAffinity.leading,
                value: widget.addOnsFormData[
                        _getProductCheckBoxSelectKey(addonFields[f], f, o)] ==
                    addonFields[f]
                            .options[o]
                            .label
                            .toLowerCase()
                ...
                onChanged: (bool value) {
                  if (value) {
                    setState(() {
                      widget.addOnsFormData[_getProductCheckBoxSelectKey(
                          addonFields[f], f, o)] = addonFields[f]
                              .options[o]
                              .label
                              .toLowerCase()
                              .replaceAll(' ', '-') +
        ...
        if (addonFields[f].type == 'multiple_choice' &&
            addonFields[f].display == 'radiobutton') {
          list.add(ListTile(
            contentPadding: EdgeInsets.all(0),
            title: Text(addonFields[f].name, style: headingStyle),
            subtitle: Text(addonFields[f].description),
            ...
            list.add(
              RadioListTile<String>(
                ...
                value: addonFields[f]
                    ...
                    .replaceAll(' ', '-'),
                groupValue: widget
                    .addOnsFormData[_getProductRadioKey(addonFields[f], f)],
                onChanged: (String value) {
                  setState(() {
                    widget.addOnsFormData[
                        _getProductRadioKey(addonFields[f], f)] = value;
                  });
                },
              ),
            );
        ...
        if (addonFields[f].type == 'select') {
          if (widget.addOnsFormData[_getProductSelectKey(addonFields[f], f)] ==
              null) {
            widget.addOnsFormData[_getProductSelectKey(addonFields[f], f)] =
                addonFields[f]
                        .options
                        .first
                        .label
          ...
          list.add(
            DropdownButton<AddonOption>(
              ...
              onChanged: (AddonOption value) {
                setState(() {
                  widget.addOnsFormData[
                      _getProductRadioKey(addonFields[f], f)] = value.label
                          .toLowerCase()
                          .replaceAll(' ', '-') +
                      '-' +
                      (addonFields[f].options.indexOf(value) + 1).toString();
                });
              },
              items: addonFields[f]
                  .options
  ...
  _getKey(List<ProductAddonsModel> productAddons, int i, int f, int o) {
    return 'addon-' +
        ...
        '-' +
        productAddons[i].fields[f].name.toLowerCase().replaceAll(' ', '-') +
        '-' +
        f.toString(); /* + '[' + productAddons[i].fields[f].options[o].label.toLowerCase().replaceAll(' ', '-') + ']'*/ /*** ADD this for lower version of addon plugin ****/
  }
  ...
  _getCheckBoxKey(List<ProductAddonsModel> productAddons, int i, int f, int o) {
    return 'addon-' +
        ...
        productAddons[i].fields[f].name.toLowerCase().replaceAll(' ', '-') +
        '-' +
        f.toString(); // + '[' + o.toString() + ']'
  }

  _getCheckBoxSelectKey(
      List<ProductAddonsModel> productAddons, int i, int f, int o) {
    return 'addon-' +
        widget.product.id.toString() +
        '-' +
        productAddons[i].fields[f].name.toLowerCase().replaceAll(' ', '-') +
  ...
  _getProductKey(AddonField addOnsField, int f, int o) {
    return 'addon-' +
        widget.product.id.toString() +
        '-' +
        addOnsField.name.toLowerCase().replaceAll(' ', '-') +
        '-' +
        f.toString(); // + '[' + addOnsField.options[o].label.toLowerCase().replaceAll(' ', '-') + ']'
  }
