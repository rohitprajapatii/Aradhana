...
class _GroupedProductState extends State<GroupedProduct> {
  ...
  Container leadingIcon() {
    return Container(
      ...
      child: CachedNetworkImage(
        imageUrl: widget.product.images[0].src != null
  ...
  _variationPrice() {
    if (widget.product.formattedPrice != null &&
        widget.product.formattedSalesPrice == null) {
      return Text(parseHtmlString(widget.product.formattedPrice),
          style: TextStyle(
            fontWeight: FontWeight.bold,
          ));
    } else if (widget.product.formattedPrice != null &&
        widget.product.formattedSalesPrice != null) {
      return Row(
        children: [
