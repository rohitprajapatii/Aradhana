...
class _VariationProductState extends State<VariationProduct> {
  ...
  Container leadingIcon() {
    return Container(
      ...
      child: CachedNetworkImage(
        imageUrl: widget.variation.image.url != null
  ...
  decreaseQty() async {
    if (widget.model.shoppingCart?.cartContents != null) {
      if (widget.model.shoppingCart.cartContents.any((cartContent) =>
          cartContent.variationId == widget.variation.variationId)) {
  ...
  getQty() {
    if (widget.model.shoppingCart.cartContents.any(
