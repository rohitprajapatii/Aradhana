                          ...
                          child: addingToCart
                              ? Container(
                                  ...
                                  child: CircularProgressIndicator(
                                      ...
                                      strokeWidth: 2.0))
                              : Text(widget
                                  .appStateModel.blocks.localeText.addToCart),
                        ),
                  ...
                  for (var i = 0;
                    ...
                    if (matchedOptions.length == selectedOptions.length) {
                      setState(() {
                        ...
                        if (widget.product.availableVariations[i].image
                                    ?.fullSrc !=
                                null &&
                            widget.product.availableVariations[i].image.fullSrc
                                .isNotEmpty)
                          widget.product.images[0].src = widget
                              .product.availableVariations[i].image.fullSrc;
        ...
        child: Row(
          children: <Widget>[
            ...
            ScopedModelDescendant<AppStateModel>(
              ...
              return Container(
                height: 55,
                child: AddButtonDetail(product: widget.product, model: model),
              );
            })
          ],
        ));
