...
class VendorCategoryScrollList extends StatefulWidget {
  ...
  VendorCategoryScrollList(
      {Key key, this.block, this.categories, this.onCategoryClick})
      : super(key: key);
  @override
  _VendorCategoryScrollListState createState() =>
      _VendorCategoryScrollListState();
}
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        AspectRatio(
                                            aspectRatio:
                                                widget.block.childHeight /
                                                    widget.block.childWidth,
                                            child: widget.categories[index]
                                                        .image !=
                                                    null
                                                ? CachedNetworkImage(
                                                    imageUrl: widget
...
class VendorCategoryScrollStadiumList extends StatefulWidget {
  ...
  final List<Category> categories;
  final Function onCategoryClick;
  VendorCategoryScrollStadiumList(
      {Key key, this.block, this.categories, this.onCategoryClick})
      : super(key: key);
  @override
  _VendorCategoryScrollStadiumListState createState() =>
      _VendorCategoryScrollStadiumListState();
}

class _VendorCategoryScrollStadiumListState
    extends State<VendorCategoryScrollStadiumList> {
  @override
  Widget build(BuildContext context) {
    final bool isDesktop = isDisplayDesktop(context);
                              ...
                              child: Column(
                                children: <Widget>[
                                  Card(
                                      ...
                                      clipBehavior: Clip.antiAlias,
                                      elevation:
                                          widget.block.elevation.toDouble(),
                                      child: InkWell(
                                        splashColor:
                                            HexColor(widget.block.bgColor)
                                                .withOpacity(0.1),
