          ...
          delegate: SliverChildBuilderDelegate(
            (BuildContext context, int index) {
              return Container(
                ...
                child: InkWell(
                    onTap: () {
                      widget.onBannerClick(widget.block.children[index]);
                    },
                    child: Card(
                        shape: widget.block.borderRadius != 50
                            ? RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(
                                    double.parse(
                                        widget.block.borderRadius.toString())),
                              )
                            : StadiumBorder(),
                          ...
                          imageBuilder: (context, imageProvider) => Ink.image(
                            child: InkWell(
                              splashColor: HexColor(widget.block.bgColor)
                                  .withOpacity(0.1),
                              onTap: () {
                                widget.onBannerClick(
                                    widget.block.children[index]);
                              },
                            ),
                            fit: BoxFit.cover,
                            image: imageProvider,
