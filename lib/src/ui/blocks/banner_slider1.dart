...
class BannerSlider1 extends StatefulWidget {
  ...
  BannerSlider1({Key key, this.block, this.onBannerClick}) : super(key: key);
  @override
                  ...
                  return InkWell(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget.block.children[index].image != null
                        ...
                        imageBuilder: (context, imageProvider) => Ink.image(
                          child: InkWell(
                            splashColor:
                                HexColor(widget.block.bgColor).withOpacity(0.1),
                            onTap: () => widget
                                .onBannerClick(widget.block.children[index]),
                          ),
                          image: imageProvider,
                          fit: BoxFit.cover,
                        ),
