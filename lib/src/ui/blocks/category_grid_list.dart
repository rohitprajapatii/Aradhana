...
class CategoryGridList extends StatefulWidget {
  ...
  CategoryGridList({Key key, this.block, this.categories, this.onCategoryClick})
      : super(key: key);
  @override
...
class _CategoryGridListState extends State<CategoryGridList> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Category> categories = widget.categories
        .where((cat) => cat.parent == widget.block.linkId)
        .toList();
              ...
              child: Card(
                ...
                child: InkWell(
                  ...
                  onTap: () => widget.onCategoryClick(
                      categories[index], widget.categories),
                  child: Column(
                    children: <Widget>[
                      AspectRatio(
...
class CategoryStadiumGridList extends StatefulWidget {
  ...
  final List<Category> categories;
  final Function onCategoryClick;
  CategoryStadiumGridList(
      {Key key, this.block, this.categories, this.onCategoryClick})
      : super(key: key);
  @override
  _CategoryStadiumGridListState createState() =>
      _CategoryStadiumGridListState();
}
