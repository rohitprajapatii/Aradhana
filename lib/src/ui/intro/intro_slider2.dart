...
class IntroScreen2State extends State<IntroScreen2> {
  ...
  Color buttonIconColor = Color(0xfff85760);
  Color colorDot = Colors.black12;
  Color colorActiveDot = Color(0xfff85760);
  ...
  void initState() {
    ...
    slides.add(
      new Slide(
        ...
        description:
            "Best online grocery, Fresh Fruits, Vegetables, Fish, Meat, Dairy & essentials. Delivering at your doorstep",
        styleDescription: TextStyle(
            color: descriptionColor,
            fontSize: 20.0,
            fontStyle: FontStyle.italic,
            fontFamily: 'Raleway'),
        pathImage: "lib/assets/images/intro/delivery_road.json",
      ),
    );
    slides.add(
      new Slide(
        ...
        styleTitle: TextStyle(
            ...
            fontFamily: 'RobotoMono'),
        description:
            "Online food delivery services in your town. Order food online from your favourite restaurants near to you. Get it delivered at your door step",
        styleDescription: TextStyle(
            color: descriptionColor,
            fontSize: 20.0,
            fontStyle: FontStyle.italic,
            fontFamily: 'Raleway'),
        pathImage: "lib/assets/images/intro/food_cooking.json",
      ),
    );
    slides.add(
      new Slide(
        ...
        styleTitle: TextStyle(
            ...
            fontFamily: 'RobotoMono'),
        description:
            "Fastest delivery service for you. Order anything online and avail fast and reliable delivery",
        styleDescription: TextStyle(
            color: descriptionColor,
            fontSize: 20.0,
            fontStyle: FontStyle.italic,
            fontFamily: 'Raleway'),
        pathImage: "lib/assets/images/intro/delivery.json",
      ),
    );
  }
