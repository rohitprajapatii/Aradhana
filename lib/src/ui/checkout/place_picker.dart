...
class PlacePicker extends StatefulWidget {
  ...
  ///
  /// TODO Replace this "GOOGLE_MAP_API_KEY" with your google map apiKey:
  final String apiKey = 'AIzaSyAbCInw-fLOIHaZqnozjUIfWa-u1hbbU4c';
  ...
  PlacePicker({this.displayLocation});
  ...
  void reverseGeocodeLatLng(LatLng latLng) {
    http
      ...
      if (response.statusCode == 200) {
        ...
        String locality = result['address_components'][1]['long_name'];
        String city = result['address_components'][3]['long_name'];
        String state = result['address_components'][5]['short_name'];
        String country = result['address_components'][6]['short_name'];
        String pinCode = result['address_components'][7]['short_name'];
