                        ...
                        child: PrimaryColorOverride(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                hintText: widget
                                    .appStateModel.blocks.localeText.couponCode,
                                suffix: InkWell(
                                  child: Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 8.0),
                                    child: Text(widget
                                        .appStateModel.blocks.localeText.apply
                                        .toUpperCase()),
                                  ),
                                  onTap: () {
                ...
                child: RaisedButton(
                  ...
                  onPressed: () async {
                    if (widget.appStateModel.blocks.settings
                                .switchWebViewCheckout ==
                            1 &&
                        widget.appStateModel.loggedIn) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                                parseHtmlString(widget.product.formattedPrice)),
                            Row(
