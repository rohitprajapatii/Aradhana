        ...
        child: Row(
          ...
          children: <Widget>[
            Container(
              ...
              width: 100,
              child: ClipRRect(
                  borderRadius: BorderRadius.circular(6), child: featuredImage),
            ),
            Expanded(
              flex: 6,
              child: Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        ...
                        widget.store.description != null
                            ? Text(parseHtmlString((widget.store.description)),
                        ...
                        widget.store.address?.city != null
                            ? Text(widget.store.address.city,
                                style: TextStyle(
                                  fontSize: 14,
