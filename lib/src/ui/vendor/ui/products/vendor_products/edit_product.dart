                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: appStateModel.blocks.localeText.description,
                      ),
                      onSaved: (val) =>
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: appStateModel.blocks.localeText.regularPrice,
                      ),
                      validator: (value) {
                        if (value.isEmpty) {
                          return appStateModel.blocks.localeText.pleaseEnter +
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: appStateModel.blocks.localeText.salesPrice,
                      ),
                      validator: (value) {
                        if (value.isEmpty) {
                          return appStateModel.blocks.localeText.pleaseEnter +
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: appStateModel.blocks.localeText.purchaseNote,
                      ),
                      onSaved: (val) =>
                    ...
                    widget.product.type == "variable"
                        ? ListTile(
                            ...
                            title: Text(
                              appStateModel.blocks.localeText.variations,
                            ),
