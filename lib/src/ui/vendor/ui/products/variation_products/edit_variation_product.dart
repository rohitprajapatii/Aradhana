...
class EditVariationProduct extends StatefulWidget {
  ...
  EditVariationProduct(
      {Key key, this.vendorBloc, this.product, this.variationProduct})
      : super(key: key);
  @override
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  labelText: _appStateModel.blocks.localeText.description),
              onSaved: (val) =>
            ...
            Text(_appStateModel.blocks.localeText.stockStatus,
                ...
                child: RaisedButton(
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      ...
                      widget.vendorBloc.editVariationProduct(
                          widget.product.id, widget.variationProduct);
