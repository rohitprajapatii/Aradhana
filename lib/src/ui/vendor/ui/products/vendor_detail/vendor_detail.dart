              ...
              child: NestedScrollView(
                        ...
                        child: Align(
                          ...
                          child: TabBar(
                            ...
                            tabs: <Widget>[
                              Tab(
                                child:
                                    Text(appStateModel.blocks.localeText.home),
                              ),
                              Tab(
                                child: Text(
                ...
                body: TabBarView(
                  ...
                  children: <Widget>[
                    ...
                    VendorReviewsList(
                        vendorDetailModel: widget.vendorDetailModel),
                  ...
                  return FabCircularMenu(
                    ...
                    options: <Widget>[
                            ...
                            if (appStateModel.user?.id != null &&
                              ...
                              _chatWithVendor(
                                  appStateModel.user.id.toString() +
                                      model.vendorDetails.store.id.toString(),
                                  model.vendorDetails.store.id.toString(),
                                  model.vendorDetails.store.name,
                                  model.vendorDetails.store.icon);
                            else {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                      ...
                      IconButton(
                          ...
                          onPressed: () {
                            openLink('sms:' + model.vendorDetails.store.phone);
                          },
                          iconSize: 20.0,
                          color: Colors.black),
                      IconButton(
                          ...
                          onPressed: () {
                            openLink('tel:' + model.vendorDetails.store.phone);
                          },
                          iconSize: 20.0,
                          color: Colors.black),
                    ],
