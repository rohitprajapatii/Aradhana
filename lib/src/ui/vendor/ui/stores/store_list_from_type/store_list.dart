          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: store.isClosed ? Card(
                ...
                elevation: 0,
                child: Container(
                    padding: new EdgeInsets.symmetric(vertical:5.0, horizontal: 8.0),
                    child: Text("Closed",style: TextStyle(fontSize: 14.0,color: Colors.white),),
                ),
              ) : Card(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.only(
                ...
                child: Container(
                  padding: new EdgeInsets.symmetric(vertical:5.0, horizontal: 8.0),
                  child: Text("Open", style: TextStyle(fontSize: 14.0,color: Colors.white),),
        ),
              )
                    /*Container(
                  padding: new EdgeInsets.symmetric(vertical:5.0, horizontal: 8.0),
                  color: Colors.red,
                  child: Text("Closed",style: TextStyle(fontSize: 20.0,color: Colors.white),),
                transform: new Matrix4.rotationZ(0.1)
                  //Text("Open",style: TextStyle(fontSize: 20.0,color: Colors.white),),
