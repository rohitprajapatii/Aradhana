...
class _Categories9State extends State<Categories9> {
      ...
      body: ScopedModelDescendant<AppStateModel>(
        builder: (context, child, model) {
          if (model.blocks?.categories != null) {
            return CategoryList(categories: model.blocks.categories);
          }
      ...
      children: [
        Container(
          decoration: BoxDecoration(
            color: _isExpanded
                ? _backgroundColor.value ?? Colors.yellow.withOpacity(.3)
                : Colors.transparent,
            border: Border(
    ...
    return AnimatedBuilder(
      ...
      child: closed
          ...
          : Container(
              ...
              child: Wrap(
                  alignment: WrapAlignment.start, children: widget.children)),
    );
  }
}
