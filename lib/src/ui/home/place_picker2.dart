...
import 'package:place_picker/widgets/widgets.dart' hide SearchInput;
...
class PlacePicker2 extends StatefulWidget {
  ...
  PlacePicker2(this.apiKey, {this.displayLocation});

  @override
  State<StatefulWidget> createState() => PlacePicker2State();
}

/// Place picker state
class PlacePicker2State extends State<PlacePicker2> {
  ...
  void initState() {
    super.initState();
    markers.add(Marker(
      position: widget.displayLocation ?? LatLng(26.1826, 28.0040),
          ...
          Expanded(
            child: GoogleMap(
              initialCameraPosition: CameraPosition(
                  target: widget.displayLocation ?? LatLng(26.1826, 28.0040),
                  zoom: 12),
          ...
          if (!this.hasSearchTerm)
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  SelectPlaceAction(
                      getLocationName(), () => {Navigator.of(context).pop()}),
                  Divider(height: 8),
                  Padding(
                    child:
  ...
  void decodeAndSelectPlace(AutoCompleteItem aci) async {
    clearOverlay();
