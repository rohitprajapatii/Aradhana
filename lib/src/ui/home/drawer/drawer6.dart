                      ...
                      FadeTransition(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ListTile(
                              title: Text(
                                  widget.appStateModel.blocks.localeText.home),
                            ...
                            ScopedModelDescendant<AppStateModel>(
                              ...
                              return model.loggedIn
                                  ? ListTile(
                                      title: Text(widget.appStateModel.blocks
                                          .localeText.account),
                                      leading: Icon(FlutterIcons.user_fea),
                                      trailing: Icon(
                                        CupertinoIcons.right_chevron,
                            ...
                            ListTile(
                              title: Text(widget
                                  .appStateModel.blocks.localeText.category),
                            ...
                            ListTile(
                              ...
                              title: Text(
                                  widget.appStateModel.blocks.localeText.sales),
                              onTap: () {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => ProductsWidget(
                                            filter: filter,
                                            name: widget.appStateModel.blocks
                                                .localeText.featured)));
                              },
                            ),
                            ListTile(
                            ...
                            ListTile(
                              ...
                              title: Text(widget.appStateModel.blocks.localeText
                                  .localeTextNew),
                              onTap: () {
                                var filter = new Map<String, dynamic>();
                                Navigator.push(
