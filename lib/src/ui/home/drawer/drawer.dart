...
class _MyDrawerState extends State<MyDrawer> {
      ...
      child: Container(
        ...
        child: ScopedModelDescendant<AppStateModel>(
          ...
          if (model.blocks?.categories != null) {
            List<Category> mainCategories = model.blocks.categories
                      ...
                      leading: Padding(
                        ...
                        child: Container(
                          ...
                          child: Icon(FontAwesomeIcons.shoppingBasket,
                              size: 20, color: Colors.orangeAccent[100]),
                        ),
                      ),
                      subtitle: Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Text('5% Discount on all orders',
                            style: TextStyle(
                                fontWeight: FontWeight.w800,
                                fontFamily: 'Lexend_Deca',
                                letterSpacing: 0.5,
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => ProductsWidget(
                                    filter: filter,
                                    name: widget.appStateModel.blocks.localeText
                                        .sales)));
                      },
                    ),
                    ListTile(
                      leading: _buildLeadingIcon(
                          ...
                          iconColor: Colors.white),
                      title: Text(
                          widget.appStateModel.blocks.localeText.localeTextNew,
                          style: menuItemStyle()),
                      onTap: () {
                        var filter = new Map<String, dynamic>();
                        Navigator.push(
  ...
  Color leadingIconColor() => Theme.of(context).brightness == Brightness.light
      ? Colors.blueGrey
      : Colors.grey;
  Color trailingIconColor() => Theme.of(context).brightness == Brightness.light
      ? Colors.grey
      : Colors.grey;
      ...
      child: Column(
        children: <Widget>[
          ListTile(
            ...
            title: Text(parseHtmlString(category.name), style: menuItemStyle()),
          ),
          _divider(context),
        ],
      ),
  ...
  void _onTapTag({String tag, String name}) {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ProductsWidget(filter: filter, name: name)));
  }
