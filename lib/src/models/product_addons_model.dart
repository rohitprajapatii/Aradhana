...
List<ProductAddonsModel> productAddonsFromJson(String str) =>
    List<ProductAddonsModel>.from(
        json.decode(str).map((x) => ProductAddonsModel.fromJson(x)));
