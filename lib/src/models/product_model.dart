...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        upsellIds: json["upsell_ids"] == null
            ? null
            : List<int>.from(json["upsell_ids"].map((x) => x)),
        ...
        images: json["images"] == null
            ? null
            : List<Mage>.from(json["images"].map((x) => Mage.fromJson(x))),
        ...
        availableVariations: json["availableVariations"] == null
            ? null
            : List<AvailableVariation>.from(json["availableVariations"]
                .map((x) => AvailableVariation.fromJson(x))),
        variationOptions: json["variationOptions"] == null
            ? null
            : List<VariationOption>.from(json["variationOptions"]
        ...
        children: json['children'] == null
            ? null
            : List<Product>.from(
                json["children"].map((x) => Product.fromJson(x))),
      );
}
...
class Vendor {
  ...
  factory Vendor.fromJson(Map<String, dynamic> json) => Vendor(
        ...
        name: json["name"] == null ? null : json["name"],
        icon:
            json["icon"] == null || json["icon"] == false ? null : json["icon"],
      );
  ...
  factory AvailableVariation.fromJson(Map<String, dynamic> json) =>
      AvailableVariation(
        ...
        displayPrice: json["display_price"] == null
            ? null
            : json["display_price"].toDouble(),
        displayRegularPrice: json["display_regular_price"] == null
            ? null
            : json["display_regular_price"].toDouble(),
        image: json["image"] == null
            ? null
            : AvailableVariationImage.fromJson(json["image"]),
        ...
        isPurchasable:
            json["is_purchasable"] == null ? null : json["is_purchasable"],
        ...
        sku: json["sku"] == null ? null : json["sku"],
        variationDescription: json["variation_description"] == null
            ? null
...
class AvailableVariationImage {
  ...
  factory AvailableVariationImage.fromJson(Map<String, dynamic> json) =>
      AvailableVariationImage(
        ...
        galleryThumbnailSrc: json["gallery_thumbnail_src"] == null
            ? null
            : json["gallery_thumbnail_src"],
