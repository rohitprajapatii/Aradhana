...
List<VendorReviews> vendorReviewsFromJson(String str) =>
    List<VendorReviews>.from(
        json.decode(str).map((x) => VendorReviews.fromJson(x)));

String vendorReviewsToJson(List<VendorReviews> data) =>
...
class VendorReviews {
  ...
  factory VendorReviews.fromJson(Map<String, dynamic> json) => VendorReviews(
        ...
        reviewDescription: json["review_description"] == null
            ? null
            : json["review_description"],
        reviewRating:
            json["review_rating"] == null ? null : json["review_rating"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "review_description":
            reviewDescription == null ? null : reviewDescription,
