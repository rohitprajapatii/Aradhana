...
List<ProductAttribute> productAttributeFromJson(String str) =>
    List<ProductAttribute>.from(
        json.decode(str).map((x) => ProductAttribute.fromJson(x)));

String productAttributeToJson(List<ProductAttribute> data) =>
...
List<AttributeTerms> attributeTermsFromJson(String str) =>
    List<AttributeTerms>.from(
        json.decode(str).map((x) => AttributeTerms.fromJson(x)));

String attributeTermsToJson(List<AttributeTerms> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
