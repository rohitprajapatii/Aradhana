...
String productVariationToJson(List<ProductVariation> data) =>
...
class ProductVariation {
  ...
  factory ProductVariation.fromJson(Map<String, dynamic> json) =>
      ProductVariation(
        ...
        price:
            json["price"] == null || json["price"] == '' ? '0' : json["price"],
        regularPrice: json["regular_price"] == null || json["price"] == ''
            ? '0'
            : json["regular_price"],
        ...
        attributes: json["attributes"] == null
            ...
            : List<VariationAttribute>.from(
                json["attributes"].map((x) => VariationAttribute.fromJson(x))),
