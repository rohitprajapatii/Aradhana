...
class CartModel {
  ...
  factory CartModel.fromJson(Map<String, dynamic> json) {
    return CartModel(
      ...
      cartContents: json["cartContents"] == null
          ? null
          : new List<CartContent>.from(
              json["cartContents"].map((x) => CartContent.fromJson(x))),
      ...
      purchasePoint:
          json["purchase_point"] == null ? null : json["purchase_point"],
      currency: json["currency"] == null ? 'USD' : json["currency"],
      cartFees: json["cart_fees"] == null
          ? null
          : List<CartFee>.from(
              json["cart_fees"].map((x) => CartFee.fromJson(x))),
...
class CartContent {
  ...
  factory CartContent.fromJson(Map<String, dynamic> json) => new CartContent(
        ...
        lineSubtotal: json["line_subtotal"] == null
            ? null
            : json["line_subtotal"].toDouble(),
        lineSubtotalTax: json["line_subtotal_tax"] == null
            ? null
            : json["line_subtotal_tax"].toDouble(),
        lineTotal:
            json["line_total"] == null ? null : json["line_total"].toDouble(),
        ...
        salesPrice:
            json["sales_price"] == null ? null : json["sales_price"].toDouble(),
        formattedPrice:
            json["formated_price"] == null ? null : json["formated_price"],
        formattedSalesPrice: json["formated_sales_price"] == null
            ? null
            : json["formated_sales_price"],
        loadingQty: false,
...
class CartTotals {
  ...
  factory CartTotals.fromJson(Map<String, dynamic> json) => new CartTotals(
        ...
        subtotalTax: (json["subtotal_tax"] == null || json["subtotal_tax"] == 0)
            ? null
            : json["subtotal_tax"],
        shippingTotal:
            json["shipping_total"] == 0 ? '0' : json["shipping_total"],
        ...
        cartContentsTotal: json["cart_contents_total"] == 0
            ? '0'
            : json["cart_contents_total"],
...
class Points {
  ...
  factory Points.fromJson(Map<String, dynamic> json) => new Points(
        ...
        discountAvailable: json["discount_available"] == null
            ? null
            : json["discount_available"].toDouble(),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "discount_available":
            discountAvailable == null ? null : discountAvailable,
