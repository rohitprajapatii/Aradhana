...
CheckoutFormModel checkoutFormModelFromJson(String str) =>
    CheckoutFormModel.fromJson(json.decode(str));

String checkoutFormModelToJson(CheckoutFormModel data) =>
...
class CheckoutFormModel {
  ...
  factory CheckoutFormModel.fromJson(Map<String, dynamic> json) =>
      CheckoutFormModel(
        billingFirstName: json["billing_first_name"] == null
            ? ''
            : json["billing_first_name"],
        billingLastName:
            json["billing_last_name"] == null ? '' : json["billing_last_name"],
        billingCompany:
            json["billing_company"] == null ? '' : json["billing_company"],
        billingCountry:
            json["billing_country"] == null ? '' : json["billing_country"],
        billingAddress1:
            json["billing_address_1"] == null ? '' : json["billing_address_1"],
        billingAddress2:
            json["billing_address_2"] == null ? '' : json["billing_address_2"],
        billingCity: json["billing_city"] == null ? '' : json["billing_city"],
        billingState:
            json["billing_state"] == null ? '' : json["billing_state"],
        billingPostcode:
            json["billing_postcode"] == null ? '' : json["billing_postcode"],
        billingPhone:
            json["billing_phone"] == null ? '' : json["billing_phone"],
        billingEmail:
            json["billing_email"] == null ? '' : json["billing_email"],
        shippingFirstName: json["shipping_first_name"] == null
            ? ''
            : json["shipping_first_name"],
        shippingLastName: json["shipping_last_name"] == null
            ? ''
            : json["shipping_last_name"],
        shippingCompany:
            json["shipping_company"] == null ? '' : json["shipping_company"],
        shippingCountry:
            json["shipping_country"] == null ? '' : json["shipping_country"],
        ...
        shippingCity:
            json["shipping_city"] == null ? '' : json["shipping_city"],
        shippingState:
            json["shipping_state"] == null ? '' : json["shipping_state"],
        shippingPostcode:
            json["shipping_postcode"] == null ? '' : json["shipping_postcode"],
        ...
        checkoutNonce:
            json["checkout_nonce"] == null ? '' : json["checkout_nonce"],
        wpnonce: json["_wpnonce"] == null ? '' : json["_wpnonce"],
        checkoutLogin:
            json["checkout_login"] == null ? false : json["checkout_login"],
        saveAccountDetails: json["save_account_details"] == null
            ? null
            : json["save_account_details"],
        userLogged: json["user_logged"] == null ? null : json["user_logged"],
      );

  Map<String, dynamic> toJson() => {
        "billing_first_name":
            billingFirstName == null ? null : billingFirstName,
        ...
        "save_account_details":
            saveAccountDetails == null ? null : saveAccountDetails,
...
class Nonce {
  ...
  factory Nonce.fromJson(Map<String, dynamic> json) => Nonce(
        ...
        updateOrderReviewNonce: json["update_order_review_nonce"] == null
            ? null
            : json["update_order_review_nonce"],
        applyCouponNonce: json["apply_coupon_nonce"] == null
            ? null
            : json["apply_coupon_nonce"],
        removeCouponNonce: json["remove_coupon_nonce"] == null
            ? null
            : json["remove_coupon_nonce"],
        optionGuestCheckout: json["option_guest_checkout"] == null
            ? null
            : json["option_guest_checkout"],
        checkoutUrl: json["checkout_url"] == null ? null : json["checkout_url"],
        debugMode: json["debug_mode"] == null ? null : json["debug_mode"],
        i18NCheckoutError: json["i18n_checkout_error"] == null
            ? null
            : json["i18n_checkout_error"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "update_order_review_nonce":
            updateOrderReviewNonce == null ? null : updateOrderReviewNonce,
        "apply_coupon_nonce":
            applyCouponNonce == null ? null : applyCouponNonce,
        "remove_coupon_nonce":
            removeCouponNonce == null ? null : removeCouponNonce,
        "option_guest_checkout":
            optionGuestCheckout == null ? null : optionGuestCheckout,
        "checkout_url": checkoutUrl == null ? null : checkoutUrl,
        "debug_mode": debugMode == null ? null : debugMode,
        "i18n_checkout_error":
            i18NCheckoutError == null ? null : i18NCheckoutError,
      };
}
