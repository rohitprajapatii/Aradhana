...
StripeSourceModel stripeSourceModelFromJson(String str) =>
    StripeSourceModel.fromJson(json.decode(str));

String stripeSourceModelToJson(StripeSourceModel data) =>
...
class StripeSourceModel {
  ...
  factory StripeSourceModel.fromJson(Map<String, dynamic> json) =>
      StripeSourceModel(
...
class Card {
  ...
  factory Card.fromJson(Map<String, dynamic> json) => Card(
        ...
        threeDSecure:
            json["three_d_secure"] == null ? null : json["three_d_secure"],
        name: json["name"],
