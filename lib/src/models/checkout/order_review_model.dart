...
class OrderReviewModel {
  ...
  factory OrderReviewModel.fromJson(Map<String, dynamic> json) =>
      new OrderReviewModel(
        ...
        balanceFormatted:
            json["balanceFormatted"] == null ? '' : json["balanceFormatted"],
        totals: json["totals"] == null ? null : Totals.fromJson(json["totals"]),
        totalsUnformatted: json["totalsUnformatted"] == null
            ? null
            : Totals.fromJson(json["totalsUnformatted"]),
        //chosenShipping: json["chosen_shipping"] == null ? null : new List<dynamic>.from(json["chosen_shipping"].map((x) => x)),
        shipping: json["shipping"] == null
            ? null
            : new List<Shipping>.from(
                json["shipping"].map((x) => Shipping.fromJson(x))),
        paymentMethods: json["paymentMethods"] == null
            ? []
            : new List<WooPaymentMethod>.from(json["paymentMethods"]
                .map((x) => WooPaymentMethod.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "chosen_shipping": chosenShipping == null
            ? null
            : new List<dynamic>.from(chosenShipping.map((x) => x)),
        "shipping": shipping == null
            ? null
            : new List<dynamic>.from(shipping.map((x) => x.toJson())),
        "paymentMethods": paymentMethods == null
            ? null
            : new List<dynamic>.from(paymentMethods.map((x) => x.toJson())),
      };
}
...
class Cart {
  ...
  factory Cart.fromJson(Map<String, dynamic> json) => new Cart(
        cartContents: json["cart_contents"] == null
            ? null
            : CartContents.fromJson(json["cart_contents"]),
        appliedCoupons: json["applied_coupons"] == null
            ? null
            : new List<dynamic>.from(json["applied_coupons"].map((x) => x)),
        taxDisplayCart:
            json["tax_display_cart"] == null ? null : json["tax_display_cart"],
        cartSessionData: json["cart_session_data"] == null
            ? null
            : CartSessionData.fromJson(json["cart_session_data"]),
        couponAppliedCount: json["coupon_applied_count"] == null
            ? null
            : new List<dynamic>.from(
                json["coupon_applied_count"].map((x) => x)),
        couponDiscountTotals: json["coupon_discount_totals"] == null
            ? null
            : new List<dynamic>.from(
                json["coupon_discount_totals"].map((x) => x)),
        couponDiscountTaxTotals: json["coupon_discount_tax_totals"] == null
            ? null
            : new List<dynamic>.from(
                json["coupon_discount_tax_totals"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "applied_coupons": appliedCoupons == null
            ? null
            : new List<dynamic>.from(appliedCoupons.map((x) => x)),
        "tax_display_cart": taxDisplayCart == null ? null : taxDisplayCart,
        "cart_session_data":
            cartSessionData == null ? null : cartSessionData.toJson(),
        "coupon_applied_count": couponAppliedCount == null
            ? null
            : new List<dynamic>.from(couponAppliedCount.map((x) => x)),
        "coupon_discount_totals": couponDiscountTotals == null
            ? null
            : new List<dynamic>.from(couponDiscountTotals.map((x) => x)),
        "coupon_discount_tax_totals": couponDiscountTaxTotals == null
            ? null
            : new List<dynamic>.from(couponDiscountTaxTotals.map((x) => x)),
      };
}
...
class CartContents {
  ...
  factory CartContents.fromJson(Map<String, dynamic> json) => new CartContents(
        the8Da153B3917424A1Cf24A9Cd1D7B4E9D:
            json["8da153b3917424a1cf24a9cd1d7b4e9d"] == null
                ? null
                : The8Da153B3917424A1Cf24A9Cd1D7B4E9D.fromJson(
                    json["8da153b3917424a1cf24a9cd1d7b4e9d"]),
        e610F941894B4A6488Cc1E06655862Ee:
            json["e610f941894b4a6488cc1e06655862ee"] == null
                ? null
                : E610F941894B4A6488Cc1E06655862Ee.fromJson(
                    json["e610f941894b4a6488cc1e06655862ee"]),
      );

  Map<String, dynamic> toJson() => {
        "8da153b3917424a1cf24a9cd1d7b4e9d":
            the8Da153B3917424A1Cf24A9Cd1D7B4E9D == null
                ? null
                : the8Da153B3917424A1Cf24A9Cd1D7B4E9D.toJson(),
        "e610f941894b4a6488cc1e06655862ee":
            e610F941894B4A6488Cc1E06655862Ee == null
                ? null
                : e610F941894B4A6488Cc1E06655862Ee.toJson(),
      };
}
...
class E610F941894B4A6488Cc1E06655862Ee {
  ...
  factory E610F941894B4A6488Cc1E06655862Ee.fromJson(
          Map<String, dynamic> json) =>
      new E610F941894B4A6488Cc1E06655862Ee(
        addons: json["addons"] == null
            ? null
            : new List<dynamic>.from(json["addons"].map((x) => x)),
        key: json["key"] == null ? null : json["key"],
        productId: json["product_id"] == null ? null : json["product_id"],
        variationId: json["variation_id"] == null ? null : json["variation_id"],
        variation: json["variation"] == null
            ? null
            : VariationClass.fromJson(json["variation"]),
  ...
  Map<String, dynamic> toJson() => {
        "addons": addons == null
            ? null
            : new List<dynamic>.from(addons.map((x) => x)),
...
class LineTaxData {
  ...
  factory LineTaxData.fromJson(Map<String, dynamic> json) => new LineTaxData(
        subtotal: json["subtotal"] == null
            ? null
            : new List<dynamic>.from(json["subtotal"].map((x) => x)),
        total: json["total"] == null
            ? null
            : new List<dynamic>.from(json["total"].map((x) => x)),
      );

  Map<String, dynamic> toJson() => {
        "subtotal": subtotal == null
            ? null
            : new List<dynamic>.from(subtotal.map((x) => x)),
        "total":
            total == null ? null : new List<dynamic>.from(total.map((x) => x)),
      };
}
...
class VariationClass {
  ...
  factory VariationClass.fromJson(Map<String, dynamic> json) =>
      new VariationClass(
        attributePaColor: json["attribute_pa_Color"] == null
            ? null
            : json["attribute_pa_Color"],
        attributePaSize: json["attribute_pa_Size"] == null
            ? null
            : json["attribute_pa_Size"],
      );

  Map<String, dynamic> toJson() => {
        "attribute_pa_Color":
            attributePaColor == null ? null : attributePaColor,
...
class The8Da153B3917424A1Cf24A9Cd1D7B4E9D {
  ...
  factory The8Da153B3917424A1Cf24A9Cd1D7B4E9D.fromJson(
          Map<String, dynamic> json) =>
      new The8Da153B3917424A1Cf24A9Cd1D7B4E9D(
        addons: json["addons"] == null
            ? null
            : new List<dynamic>.from(json["addons"].map((x) => x)),
        key: json["key"] == null ? null : json["key"],
...
class CartSessionData {
  ...
  factory CartSessionData.fromJson(Map<String, dynamic> json) =>
      new CartSessionData(
        ...
        subtotalExTax:
            json["subtotal_ex_tax"] == null ? null : json["subtotal_ex_tax"],
        taxTotal: json["tax_total"] == null ? null : json["tax_total"],
        taxes: json["taxes"] == null
            ? null
            : new List<dynamic>.from(json["taxes"].map((x) => x)),
        shippingTaxes: json["shipping_taxes"] == null
            ? null
            : new List<dynamic>.from(json["shipping_taxes"].map((x) => x)),
        discountCart:
            json["discount_cart"] == null ? null : json["discount_cart"],
        discountCartTax: json["discount_cart_tax"] == null
            ? null
            : json["discount_cart_tax"],
        shippingTotal:
            json["shipping_total"] == null ? null : json["shipping_total"],
        shippingTaxTotal: json["shipping_tax_total"] == null
            ? null
            : json["shipping_tax_total"],
        couponDiscountAmounts: json["coupon_discount_amounts"] == null
            ? null
            : new List<dynamic>.from(
                json["coupon_discount_amounts"].map((x) => x)),
        couponDiscountTaxAmounts: json["coupon_discount_tax_amounts"] == null
            ? null
            : new List<dynamic>.from(
                json["coupon_discount_tax_amounts"].map((x) => x)),
        feeTotal: json["fee_total"] == null ? null : json["fee_total"],
        fees: json["fees"] == null
            ? null
            : new List<dynamic>.from(json["fees"].map((x) => x)),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "taxes":
            taxes == null ? null : new List<dynamic>.from(taxes.map((x) => x)),
        "shipping_taxes": shippingTaxes == null
            ? null
            : new List<dynamic>.from(shippingTaxes.map((x) => x)),
        ...
        "shipping_tax_total":
            shippingTaxTotal == null ? null : shippingTaxTotal,
        "coupon_discount_amounts": couponDiscountAmounts == null
            ? null
            : new List<dynamic>.from(couponDiscountAmounts.map((x) => x)),
        "coupon_discount_tax_amounts": couponDiscountTaxAmounts == null
            ? null
            : new List<dynamic>.from(couponDiscountTaxAmounts.map((x) => x)),
        "fee_total": feeTotal == null ? null : feeTotal,
        "fees":
            fees == null ? null : new List<dynamic>.from(fees.map((x) => x)),
      };
}
...
class WooPaymentMethod {
  ...
  factory WooPaymentMethod.fromJson(Map<String, dynamic> json) =>
      new WooPaymentMethod(
        ...
        icon: (json["icon"] == null || json["icon"] == false)
            ? null
            : json["icon"],
        supports: json["supports"] == null
            ? null
            : new List<String>.from(json["supports"].map((x) => x)),
        maxAmount: json["max_amount"] == null ? null : json["max_amount"],
        viewTransactionUrl: json["view_transaction_url"] == null
            ? null
            : json["view_transaction_url"],
        newMethodLabel:
            json["new_method_label"] == null ? null : json["new_method_label"],
        ...
        formFields: json["form_fields"] == null
            ? null
            : FormFields.fromJson(json["form_fields"]),
        instructions:
            json["instructions"] == null ? null : json["instructions"],
        payStackPublicKey:
            json["public_key"] == null ? null : json["public_key"],
        stripePublicKey:
  ...
  Map<String, dynamic> toJson() => {
        ...
        "supports": supports == null
            ? null
            : new List<dynamic>.from(supports.map((x) => x)),
        "max_amount": maxAmount == null ? null : maxAmount,
        "view_transaction_url":
            viewTransactionUrl == null ? null : viewTransactionUrl,
...
class FormFields {
  ...
  factory FormFields.fromJson(Map<String, dynamic> json) => new FormFields(
        enabled:
            json["enabled"] == null ? null : Enabled.fromJson(json["enabled"]),
        title:
        ...
        instructions: json["instructions"] == null
            ? null
            : Description.fromJson(json["instructions"]),
      );
...
class Shipping {
  ...
  factory Shipping.fromJson(Map<String, dynamic> json) => new Shipping(
        ...
        showPackageDetails: json["show_package_details"] == null
            ? null
            : json["show_package_details"],
        showShippingCalculator: json["show_shipping_calculator"] == null
            ? null
            : json["show_shipping_calculator"],
        packageDetails:
            json["package_details"] == null ? null : json["package_details"],
        packageName: json["package_name"] == null ? null : json["package_name"],
        index: json["index"] == null ? null : json["index"].toString(),
        chosenMethod:
            (json["chosen_method"] == null || json["chosen_method"] == false)
                ? ''
                : json["chosen_method"],
        shippingMethods: json["shippingMethods"] == null
            ? []
            : new List<ShippingMethod>.from(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "show_package_details":
            showPackageDetails == null ? null : showPackageDetails,
        "show_shipping_calculator":
            showShippingCalculator == null ? null : showShippingCalculator,
        ...
        "shippingMethods": shippingMethods == null
            ? null
            : new List<dynamic>.from(shippingMethods.map((x) => x.toJson())),
      };
}
...
class Package {
  ...
  factory Package.fromJson(Map<String, dynamic> json) => new Package(
        ...
        contentsCost: json["contents_cost"] == null
            ? null
            : json["contents_cost"].toDouble(),
        appliedCoupons: json["applied_coupons"] == null
            ? null
            : new List<dynamic>.from(json["applied_coupons"].map((x) => x)),
...
class Totals {
  ...
  factory Totals.fromJson(Map<String, dynamic> json) => new Totals(
        ...
        subtotalTax: json["subtotal_tax"] == null
            ? null
            : json["subtotal_tax"].toString(),
        shippingTotal: json["shipping_total"] == null
            ? null
            : json["shipping_total"].toString(),
        shippingTax: json["shipping_tax"] == null
            ? null
            : json["shipping_tax"].toString(),
        ...
        discountTax: json["discount_tax"] == null
            ? null
            : json["discount_tax"].toString(),
        cartContentsTotal: json["cart_contents_total"] == null
            ? null
            : json["cart_contents_total"].toString(),
        ...
        feeTotal:
            json["fee_total"] == null ? null : json["fee_total"].toString(),
        ...
        totalTax:
            json["total_tax"] == null ? null : json["total_tax"].toString(),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "cart_contents_taxes": cartContentsTaxes == null
            ? null
            : new List<dynamic>.from(cartContentsTaxes.map((x) => x)),
        "fee_total": feeTotal == null ? null : feeTotal,
        "fee_tax": feeTax == null ? null : feeTax,
        "fee_taxes": feeTaxes == null
            ? null
            : new List<dynamic>.from(feeTaxes.map((x) => x)),
        "total": total == null ? null : total,
