...
StripeTokenModel stripeTokenModelFromJson(String str) =>
    StripeTokenModel.fromJson(json.decode(str));

String stripeTokenModelToJson(StripeTokenModel data) =>
...
class StripeTokenModel {
  ...
  factory StripeTokenModel.fromJson(Map<String, dynamic> json) =>
      StripeTokenModel(
...
class Card {
  ...
  factory Card.fromJson(Map<String, dynamic> json) => Card(
        ...
        addressCountry:
            json["address_country"] == null ? null : json["address_country"],
        addressLine1:
        ...
        addressState:
            json["address_state"] == null ? null : json["address_state"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "address_line1_check":
            addressLine1Check == null ? null : addressLine1Check,
