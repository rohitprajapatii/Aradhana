...
class BlocksModel {
  ...
  factory BlocksModel.fromJson(Map<String, dynamic> json) => BlocksModel(
        ...
        recentProducts: json["recentProducts"] == null
            ? []
            : List<Product>.from(
                json["recentProducts"].map((x) => Product.fromJson(x))),
        pages: json["pages"] == null
            ? []
            : List<Child>.from(json["pages"].map((x) => Child.fromJson(x))),
        ...
        featured: json["featured"] == null
            ? []
            : List<Product>.from(
                json["featured"].map((x) => Product.fromJson(x))),
        onSale: json["on_sale"] == null
            ? []
            : List<Product>.from(
                json["on_sale"].map((x) => Product.fromJson(x))),
        bestSelling: json["best_selling"] == null
            ? []
            : List<Product>.from(
                json["best_selling"].map((x) => Product.fromJson(x))),
        ...
        localeText:
            json["locale"] == null ? null : LocaleText.fromJson(json["locale"]),
        language: 'en',
        splash: json["splash"] == null || json["splash"] == ''
            ? null
            : List<Child>.from(json["splash"].map((x) => Child.fromJson(x))),
        nonce: json["nonce"] == null ? null : Nonce.fromJson(json["nonce"]),
        stores: json["stores"] == null
            ? null
            : List<StoreModel>.from(
                json["stores"].map((x) => StoreModel.fromJson(x))),
        pageLayout: json["pageLayout"] == null
            ? PageLayout.fromJson({})
            : PageLayout.fromJson(json["pageLayout"]),
...
class Nonce {
  ...
  factory Nonce.fromJson(Map<String, dynamic> json) => Nonce(
        wooWalletTopup:
            json["woo_wallet_topup"] == null ? null : json["woo_wallet_topup"],
      );
}
...
class LocaleText {
  ...
  factory LocaleText.fromJson(Map<String, dynamic> json) => LocaleText(
        ...
        companyName: json["Company Name"] == null
            ? "Company Name"
            : json["Company Name"],
        category: json["Category"] == null ? "Category" : json["Category"],
        categories:
            json["Categories"] == null ? "Categories" : json["Categories"],
        cart: json["Cart"] == null ? "Cart" : json["Cart"],
        addToCart:
            json["Add to cart"] == null ? "Add to cart" : json["Add to cart"],
        buyNow: json["Buy now"] == null ? "Buy now" : json["Buy now"],
        outOfStock: json["Out of stock"] == null
            ? "Out of stock"
            : json["Out of stock"],
        ...
        localeTextContinue:
            json["Continue"] == null ? "Continue" : json["Continue"],
        ...
        newArrivals: json["New Arrivals"] == null
            ? "New Arrivals"
            : json["New Arrivals"],
        ...
        firstName:
            json["First Name"] == null ? "First Name" : json["First Name"],
        ...
        selectLocation: json["Select location"] == null
            ? "Select location"
            : json["Select location"],
        ...
        justForYou: json["Just for you"] == null
            ? "Just for you"
            : json["Just for you"],
        youMayAlsoLike: json["You may also like"] == null
            ? "You may also like"
            : json["You may also like"],
        ...
        paymentMethod: json["Payment method"] == null
            ? "Payment method"
            : json["Payment method"],
        shippingMethod: json["Shipping method"] == null
            ? "Shipping method"
            : json["Shipping method"],
        ...
        noMoreOrders: json["No more orders"] == null
            ? "No more orders"
            : json["No more orders"],
        noWishlist:
            json["No wishlist"] == null ? "No wishlist" : json["No wishlist"],
        noMoreWishlist: json["No more wishlist"] == null
            ? "No more wishlist"
            : json["No more wishlist"],
        localeTextNew: json["New"] == null ? "New" : json["New"],
        otp: json["OTP"] == null ? "OTP" : json["OTP"],
        reset: json["Reset"] == null ? "Reset" : json["Reset"],
        resetPassword: json["Reset password"] == null
            ? "Reset password"
            : json["Reset password"],
        newPassword: json["New password"] == null
            ? "New password"
            : json["New password"],
        requiredField: json["Required Field"] == null
            ? "Required Field"
            : json["Required Field"],
        pleaseEnter: json["Please enter"] == null
            ? "Please enter"
            : json["Please enter"],
        pleaseEnterUsername: json["Please enter username"] == null
            ? "Please enter username"
            : json["Please enter username"],
        pleaseEnterCompanyName: json["Please enter company name"] == null
            ? "Please enter company name"
            : json["Please enter company name"],
        pleaseEnterPassword: json["Please enter password"] == null
            ? "Please enter password"
            : json["Please enter password"],
        pleaseEnterFirstName: json["Please enter first name"] == null
            ? "Please enter first name"
            : json["Please enter first name"],
        pleaseEnterLastName: json["Please enter last name"] == null
            ? "Please enter last name"
            : json["Please enter last name"],
        pleaseEnterCity: json["Please enter city"] == null
            ? "Please enter city"
            : json["Please enter city"],
        pleaseEnterPincode: json["Please enter pincode"] == null
            ? "Please enter pincode"
            : json["Please enter pincode"],
        pleaseEnterState: json["Please enter state"] == null
            ? "Please enter state"
            : json["Please enter state"],
        pleaseEnterValidEmail: json["Please enter valid email"] == null
            ? "Please enter valid email"
            : json["Please enter valid email"],
        pleaseEnterPhoneNumber: json["Please enter phone number"] == null
            ? "Please enter phone number"
            : json["Please enter phone number"],
        pleaseEnterOtp: json["Please enter otp"] == null
            ? "Please enter otp"
            : json["Please enter otp"],
        pleaseEnterAddress: json["Please enter address"] == null
            ? "Please enter address"
            : json["Please enter address"],
        logout: json["Logout"] == null ? "Logout" : json["Logout"],
        pleaseWait:
            json["Please wait"] == null ? "Please wait" : json["Please wait"],
        language: json["Language"] == null ? "Language" : json["Language"],
        currency: json["Currency"] == null ? "Currency" : json["Currency"],
        forgotPassword: json["Forgot password"] == null
            ? "Forgot password?"
            : json["Forgot password"],
        alreadyHaveAnAccount: json["Already have an account"] == null
            ? "Already have an account?"
            : json["Already have an account"],
        dontHaveAnAccount: json["Dont have an account"] == null
            ? "Don't have an account?"
            : json["Dont have an account"],
        ...
        noProducts:
            json["No products"] == null ? "No products" : json["No products"],
        noMoreProducts: json["No more products"] == null
            ? "No more products"
            : json["No more products"],
        ...
        couponCode:
            json["Coupon code"] == null ? "Coupon code" : json["Coupon code"],
        pleaseEnterCouponCode: json["Please enter coupon code"] == null
            ? "Please enter coupon code"
            : json["Please enter coupon code"],
        emptyCart:
            json["Empty Cart"] == null ? "Empty Cart" : json["Empty Cart"],
        youOrderHaveBeenReceived: json["You order have been received"] == null
            ? "You order have been received"
            : json["You order have been received"],
        thankYouForShoppingWithUs:
            json["Thank you for shopping with us"] == null
                ? "Thank you for shopping with us"
                : json["Thank you for shopping with us"],
        thankYouOrderIdIs: json["Thank you order id is"] == null
            ? "Thank you order id is"
            : json["Thank you order id is"],
        youWillReceiveAConfirmationMessage:
            json["You will receive a confirmation message"] == null
                ? "You will receive a confirmation message"
                : json["You will receive a confirmation message"],
        ...
        variations:
            json["Variations"] == null ? "Variations" : json["Variations"],
        sku: json["SKU"] == null ? "SKU" : json["SKU"],
        description:
            json["Description"] == null ? "Description" : json["Description"],
        regularPrice: json["Regular price"] == null
            ? "Regular price"
            : json["Regular price"],
        salesPrice:
            json["Sales price"] == null ? "Sales price" : json["Sales price"],
        stockStatus: json["Stock status"] == null
            ? "Stock status"
            : json["Stock status"],
        backOrder:
            json["Back order"] == null ? "Back order" : json["Back order"],
        ...
        purchaseNote: json["Purchase Note"] == null
            ? "Purchase Note"
            : json["Purchase Note"],
        submit: json["Submit"] == null ? "Submit" : json["Submit"],
        catalogVisibility: json["Catalog Visibility"] == null
            ? "Catalog Visibility"
            : json["Catalog Visibility"],
        ...
        searchProducts: json["Search Products"] == null
            ? "Search Products"
            : json["Search Products"],
        searchStores: json["Search Stores"] == null
            ? "Search Stores"
            : json["Search Stores"],
        noResults:
            json["No Results"] == null ? "No Results" : json["No Results"],
        thankYouForYourReview: json["Thank you for your review"] == null
            ? "Thank you for your review"
            : json["Thank you for your review"],
        pleaseEnterMessage: json["Please enter message"] == null
            ? "Please enter message"
            : json["Please enter message"],
        yourReview:
            json["Your review"] == null ? "Your review" : json["Your review"],
        pleaseSelectYourRating: json["Please enter your review"] == null
            ? "Please enter your review"
            : json["Please enter your review"],
        whatIsYourRate: json["What is your rate"] == null
            ? "What is your rate"
            : json["What is your rate"],
        or: json["Or"] == null ? "Or" : json["Or"],
        sendOtp: json["Send OTP"] == null ? "Send OTP" : json["Send OTP"],
        attributes:
            json["Attributes"] == null ? "Attributes" : json["Attributes"],
        noConversationsYet: json["No conversations yet"] == null
            ? "No conversations yet"
            : json["No conversations yet"],
        ...
        addBalance:
            json["Add balance"] == null ? "Add balance" : json["Add balance"],
        enterRechargeAmount: json["Enter recharge amount"] == null
            ? "Enter recharge amount"
            : json["Enter recharge amount"],
        pleaseEnterRechargeAmount: json["Please enter recharge amount"] == null
            ? "Please enter recharge amount"
            : json["Please enter recharge amount"],
        sale: json["Sale"] == null ? "Sale" : json["Sale"],
        inValidCode: json["Invalid Code"] == null
            ? "The verification code used is invalid"
            : json["Invalid Code"],
        verifyNumber: json["Verify Number"] == null
            ? "Verify Number"
            : json["Verify Number"],
        inValidNumber: json["Invalid Number"] == null
            ? "Invalid Number"
            : json["Invalid Number"],
        enterOtp: json["Enter OTP"] == null ? "Enter OTP" : json["Enter OTP"],
        verifyOtp:
            json["Verify OTP"] == null ? "Verify OTP" : json["Verify OTP"],
        orderNote:
            json["Order Note"] == null ? "Order Note" : json["Order Note"],
        bestSelling: json["Best Selling"] == null
            ? "Best Selling"
            : json["Best Selling"],
        viewAll: json["View All"] == null ? "View All" : json["View All"],
        resendOTP: json["resendOTP"] == null ? "Resend OTP" : json["resendOTP"],
        isRequired:
            json["isRequired"] == null ? "is required" : json["isRequired"],
      );
}
...
class Block {
  ...
  factory Block.fromJson(Map<String, dynamic> json) => Block(
        ...
        bannerShadow:
            json["banner_shadow"] == null ? null : json["banner_shadow"],
        ...
        paddingRight:
            json["paddingRight"] == null ? null : json["paddingRight"],
        paddingBottom:
            json["paddingBottom"] == null ? null : json["paddingBottom"],
        ...
        marginBottom:
            json["marginBottom"] == null ? null : json["marginBottom"],
        ...
        borderRadius: json["borderRadius"] == null
            ? null
            : json["borderRadius"].toDouble(),
        childWidth:
            json["childWidth"] == null ? null : json["childWidth"].toDouble(),
        ...
        paddingBetween: json["paddingBetween"] == null
            ? null
            : json["paddingBetween"].toDouble(),
        //blockChildWidth: json["child_width"] == null ? null : json["child_width"],
        childHeight:
            json["childHeigth"] == null ? null : json["childHeigth"].toDouble(),
        elevation:
...
class Settings {
  ...
  factory Settings.fromJson(Map<String, dynamic> json) => Settings(
        ...
        showBestSelling:
            json["show_best_selling"] == null ? 0 : json["show_best_selling"],
        showStoreList:
            json["show_store_list"] == null ? 0 : json["show_store_list"],
        pullToRefresh:
            json["pull_to_refresh"] == null ? null : json["pull_to_refresh"],
        onesignalAppId:
            json["onesignal_app_id"] == null ? null : json["onesignal_app_id"],
        googleProjectId: json["google_project_id"] == null
            ? null
            : json["google_project_id"],
        googleWebClientId: json["google_web_client_id"] == null
            ? null
            : json["google_web_client_id"],
        rateAppIosId:
            json["rate_app_ios_id"] == null ? null : json["rate_app_ios_id"],
        rateAppAndroidId: json["rate_app_android_id"] == null
            ? null
            : json["rate_app_android_id"],
        rateAppWindowsId: json["rate_app_windows_id"] == null
            ? null
            : json["rate_app_windows_id"],
        shareAppAndroidLink: json["share_app_android_link"] == null
            ? null
            : json["share_app_android_link"],
        shareAppIosLink: json["share_app_ios_link"] == null
            ? null
            : json["share_app_ios_link"],
        supportEmail:
            json["support_email"] == null ? null : json["support_email"],
        enableProductChat: json["enable_product_chat"] == null
            ? null
            : json["enable_product_chat"],
        enableHomeChat:
            json["enable_home_chat"] == null ? null : json["enable_home_chat"],
        whatsappNumber:
            json["whatsapp_number"] == null ? '' : json["whatsapp_number"],
        countryDialCode: json["country_dial_code"] == null
            ? '+91'
            : json["country_dial_code"],
        appDir: json["app_dir"] == null ? null : json["app_dir"],
        switchLocations:
            json["switchLocations"] == null ? null : json["switchLocations"],
        language: json["language"] == null ? null : json["language"],
        productShadow:
            json["product_shadow"] == null ? null : json["product_shadow"],
        enableSoldBy:
            json["enable_sold_by"] == null ? null : json["enable_sold_by"],
        enableSoldByProduct: json["enable_sold_by_product"] == null
            ? null
            : json["enable_sold_by_product"],
        enableVendorChat: json["enable_vendor_chat"] == null
            ? null
            : json["enable_vendor_chat"],
        enableVendorMap: json["enable_vendor_map"] == null
            ? null
            : json["enable_vendor_map"],
        enableWallet:
            json["enable_wallet"] == null ? null : json["enable_wallet"],
        enableRefund:
            json["enable_refund"] == null ? null : json["enable_refund"],
        switchWpml: json["switchWpml"] == null ? null : json["switchWpml"],
        switchAddons:
            json["switchAddons"] == null ? null : json["switchAddons"],
        switchRewardPoints: json["switchRewardPoints"] == null
            ? null
            : json["switchRewardPoints"],
        switchWebViewCheckout: json["switchRewardPoints"] == null
            ? null
            : json["switchWebViewCheckout"],
        defaultCountry:
        ...
        siteDescription:
            json["siteDescription"] == null ? '' : json["siteDescription"],
...
class Dimensions {
  ...
  factory Dimensions.fromJson(Map<String, dynamic> json) => Dimensions(
        ...
        productSliderWidth: json["productSliderWidth"] == null
            ? null
            : json["productSliderWidth"],
        latestPerRow:
            json["latestPerRow"] == null ? null : json["latestPerRow"],
        productsPerRow:
            json["productsPerRow"] == null ? null : json["productsPerRow"],
        searchPerRow:
            json["searchPerRow"] == null ? null : json["searchPerRow"],
        productBorderRadius: json["productBorderRadius"] == null
            ? null
            : json["productBorderRadius"],
        suCatBorderRadius: json["suCatBorderRadius"] == null
            ? null
            : json["suCatBorderRadius"],
        productPadding:
            json["productPadding"] == null ? null : json["productPadding"],
      );
}
...
class Language {
  ...
  factory Language.fromJson(Map<String, dynamic> json) => Language(
        ...
        active: json["active"],
        defaultLocale:
            json["default_locale"] == null ? null : json["default_locale"],
        encodeUrl: json["encode_url"] == null ? null : json["encode_url"],
        tag: json["tag"] == null ? null : json["tag"],
        translatedName:
            json["translated_name"] == null ? null : json["translated_name"],
        url: json["url"] == null ? null : json["url"],
        countryFlagUrl:
            json["country_flag_url"] == null ? null : json["country_flag_url"],
        languageCode:
...
class PageLayout {
  ...
  PageLayout(
      {this.category, this.login, this.stores, this.account, this.product});
