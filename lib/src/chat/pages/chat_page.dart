...
class ChatPage extends StatefulWidget {
  ...
  final String chatId;
  const ChatPage(
      {Key key, this.vendorId, this.vendorName, this.vendorAvatar, this.chatId})
      : super(key: key);
  @override
...
class _ChatPageState extends State<ChatPage> {
              ...
              Align(
                ...
                child: Text(
                  timeago.format(_timestamp.toDate(),
                      locale: appStateModel.appLocale.languageCode),
                ...
                IconButton(
                    ...
                    onPressed: () {
                      ...
                      if (_formKey.currentState.validate()) {
                        ...
                        if (notify) {
                          ApiProvider().post(
                              '/wp-admin/admin-ajax.php?action=mstore_flutter_new_chat_message',
                              {
  ...
  Widget _messageTextField() {
    return TextFormField(
      ...
      decoration:
          InputDecoration(border: InputBorder.none, hintText: "Type a message"),
      autocorrect: false,
    );
  }
  ...
  _startChat() async {
    var userID = _userID;
    var userName =
        appStateModel.user.firstName + ' ' + appStateModel.user.lastName;
    ...
    String conversationID = await DBService.instance.getConversationId(
        widget.chatId,
        userID,
        userName,
        userAvatar,
